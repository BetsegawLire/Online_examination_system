...
<p>As a student, you have the ability to take exams, view your result, make preferences and view a placement With just a few clicks.</p>
<!-- <button class="manage-accounts-button">Manage Accounts</button> -->
<a  href="student/exam.php" class="manage-accounts-button" > Exam</a>
<a  href="student/result.php" class="manage-accounts-button"> Result</a>
...
<p>Simply click the "Exam" button above to get started. You'll be prompted to to try and submit the exam.</p>
<p>Simply click the "Result" button above to get started. You'll be able to view the result of your exam.</p>
