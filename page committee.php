  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      ...
      <li class="nav-item">
        ...
        <li class="nav-item">
        <a  href="committee/addquestion.php" class="nav-link" style="color: white;">Add questions</a>
        </li>
        <li class="nav-item">
        <a  href="committee/managequestion.php" class="nav-link" style="color: white;">Manage Questions</a>
        </li>
        <li class="nav-item">
